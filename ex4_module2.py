                    ...
                    if choose_line == i + 1:
                        ...
                        while True:
                            ...
                            if change_field == "name":
                                ...
                                print(
                                    "Please choose the field 'name', 'gender', 'DoB', 'salary': "
                                )
                                continue
        ...
        while True:
            while True:
                ...
                if choose_key in ["name", "gender", "DoB", "salary"]:
                    ...
                    print(
                        "Please enter the key to search 'name', 'gender', 'DoB', 'salary'"
                    )
            if choose_key == "gender":
                while True:
                    choose_gender = input(
                        "Which gender do you want to search (Male/Female)?: "
                    )
                ...
                print(
                    "######### SEARCH RESULT BY '{}' - '{}' ! ##########".format(
                        choose_key, choose_gender
                    )
                )
                for emp in Employee.list_info:
                ...
                while True:
                    ...
                    if (
                        re.match(
                            r"\d\d|\d\d\/\d\d\|\d\d\/\d\d\/(19[6-9][0-9]|200[0-2])*$",
                            choose_dob,
                        )
                        != None
                    ):
                ...
                print(
                    "######### SEARCH RESULT BY '{}' contains number '{}' ! ##########".format(
                        choose_key, choose_dob
                    )
                )
                flag = False
                for emp in Employee.list_info:
                ...
                while True:
                    try:
                        value = int(
                            input("Enter the value {} than: ".format(type_search))
                        )
                    except ValueError:
